"""
Data processing module for Books.com.tw scraper
Handles data transformation and validation for Books.com.tw book data
"""
...
class BooksComTwDataProcessor:
    """
    Processes raw book data from Books.com.tw HTML parsing
    ...
    def process_book_data(self, raw_data: Dict) -> Optional[Dict]:
        ...
        # Use format: BOOKS_COM_TW_{product_id} to avoid conflicts with Open Library IDs
        book_id = f"BOOKS_COM_TW_{product_id}"
        ...
        source_url = raw_data.get("url", f"https://www.books.com.tw/products/{product_id}")
        ...
        processed_data = {
            ...
            "price": price,
            "isbn": isbn,
            "open_library_id": None,  # Not applicable for Books.com.tw
